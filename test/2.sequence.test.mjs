import {Future, of, never, after} from '../index.mjs';
import {expect} from 'chai';
import {add, bang, noop, error, assertResolved, assertRejected, assertCrashed} from './util.mjs';
import {resolved, rejected, resolvedSlow} from './futures.mjs';
import {Sequence, Core} from '../src/core.mjs';
